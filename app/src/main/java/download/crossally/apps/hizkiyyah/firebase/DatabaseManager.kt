...
class DatabaseManager(var context: Context) {
    ...
    fun getUser(id: String) {
        val query = databaseUsers.orderByChild("id").equalTo(id).limitToLast(2)
    ...
    fun getScheduleByUser(id: String) {
        val query = databaseSchedule.orderByChild("userId").equalTo(id).limitToLast(1)
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
    ...
    fun getMeetingHistoryByUser(userId: String) {
        val query = databaseMeetingHistory.orderByChild("userId").equalTo(userId).limitToLast(2)
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
