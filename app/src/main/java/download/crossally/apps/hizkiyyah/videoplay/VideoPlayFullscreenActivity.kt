...
class VideoPlayFullscreenActivity : AppCompatActivity() {
    lateinit var fullscreenContent: BetterVideoPlayer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseDatabase.getInstance().reference.child(VIDEO_LIST).child(playsessionId).addValueEventListener(object : ValueEventListener {
